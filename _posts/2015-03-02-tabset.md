...
- メモ
    ...
    - [ドキュメント](http://docs.oracle.com/javase/jp/8/api/docs/javax/swing/text/TabSet.html)の「タブ・セットは変更できません。」は、翻訳元は「It is also immutable.」なので、「`TabSet`、`TabStop`はどちらも不変(イミュータブル)です。」の意味？

<!-- dummy comment line for breaking list -->

## 参考リンク
- [TabSet (Java Platform SE 8)](http://docs.oracle.com/javase/jp/8/api/docs/javax/swing/text/TabSet.html)
- [TabStop (Java Platform SE 8)](http://docs.oracle.com/javase/jp/8/api/docs/javax/swing/text/TabStop.html)
